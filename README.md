...
- 每一筆會輸出的來源都要填 `country`，放主所屬國家或地區，例如 `台灣`、`日本`、`香港`。
- `region` 保留較細的地理或交流脈絡，例如 `台灣/新竹`、`日本/常來台`、`香港/國際`。
...
站上顯示的資訊不是完整名冊，也不是官方認證資料庫；它更接近一個公開訊號索引。如果你發現社團、演奏者、活動或公開來源有缺漏、錯誤或失效連結，歡迎發 GitHub issue 回報。回報時最有幫助的是官方網站、公開社群頁、公開貼文、活動頁或其他能讓人確認資訊的公開來源。
