...
WORDS = {
    'en': {'brand': 'Harmonica Observatory', 'home': 'Discover', 'events': 'Events', 'post': 'Posts', 'source': 'Sources', 'scores': 'Scores', 'feeds': 'Subscribe', 'status': 'System status', 'contribute': 'Contribute API capacity', 'submit': 'Suggest a source', 'about': 'About', 'privacy': 'Privacy', 'description': 'Discover public harmonica events, artists, ensembles, clubs and scores around the world. Browse original sources across countries and languages.', 'original': 'Original sources', 'latest': 'Latest public posts', 'all': 'Browse all sources'},
    'zh-Hant': {'brand': '口琴觀測站', 'home': '探索', 'events': '活動', 'post': '貼文', 'source': '來源', 'scores': '樂譜', 'feeds': '訂閱', 'status': '系統狀態', 'contribute': '貢獻 API 額度', 'submit': '回報來源', 'about': '關於', 'privacy': '隱私', 'description': '探索全球公開口琴活動、演奏者、樂團、社團與樂譜資訊，跨越國家與語言瀏覽原始來源，保留原文與活動時區。', 'original': '原始來源', 'latest': '最新公開貼文', 'all': '瀏覽所有來源'},
    'ja': {'brand': 'Harmonica Observatory', 'home': '見つける', 'events': 'イベント', 'post': '投稿', 'source': '情報源', 'scores': '楽譜', 'feeds': '購読', 'status': '稼働状況', 'contribute': 'API 枠を提供', 'submit': '情報源を提案', 'about': 'このサイトについて', 'privacy': 'プライバシー', 'description': '世界のハーモニカイベント、演奏家、アンサンブル、クラブ、楽譜を探す公開情報サイト。国や言語を越えて原文と情報源を確認できます。', 'original': '元の情報源', 'latest': '最新の公開投稿', 'all': 'すべての情報源を見る'},
    'ko': {'brand': 'Harmonica Observatory', 'home': '둘러보기', 'events': '행사', 'post': '게시물', 'source': '정보 출처', 'scores': '악보', 'feeds': '구독', 'status': '시스템 상태', 'contribute': 'API 할당량 기여', 'submit': '출처 제안', 'about': '소개', 'privacy': '개인정보', 'description': '전 세계 하모니카 행사, 연주자, 앙상블, 동아리와 악보를 탐색하세요. 국가와 언어를 넘어 원문과 공개 출처를 확인할 수 있습니다.', 'original': '원본 출처', 'latest': '최신 공개 게시물', 'all': '모든 출처 보기'},
}
