...
REQUIRED_FILES = [
    ...
    API_DIR / "scores.json",
    API_DIR / "score-sources.json",
    API_DIR / "public-calendar-events.json",
    API_DIR / "overseas-calendar-events.json",
    API_DIR / "online-calendar-events.json",
    API_DIR / "public-calendar-sync.json",
    API_DIR / "status.json",
    SITE_DATA_DIR / "site-data.js",
    SITE_DATA_DIR / "feed-data.js",
    SITE_DATA_DIR / "score-data.js",
    SITE_DATA_DIR / "score-source-data.js",
    SITE_DATA_DIR / "public-calendar-events.js",
    FEEDS_DIR / "updates.xml",
    FEEDS_DIR / "sources.xml",
    FEEDS_DIR / "public-calendar.ics",
    FEEDS_DIR / "overseas-calendar.ics",
    FEEDS_DIR / "online-calendar.ics",
