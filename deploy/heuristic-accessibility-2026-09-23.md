...
- `/tmp/harmonica-heuristic/accessibility-drafts.cjs`: public HTTPS also confirms [#17](https://github.com/skyhong2002/harmonica-observatory/issues/17): all form fields survive each of four locale changes; a pending request blocks native and programmatic locale changes; exactly one mocked POST; token absent from local/session storage.
