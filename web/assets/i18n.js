const rows = {
  ...
  scoreSourcesBody: [
    "Find a book, read a sales announcement, or browse a library and contact a provider.",
    "找一本譜集、查看販售公告，或到曲庫與團隊網站詢問樂譜。",
    "楽譜集を探す、販売案内を読む、曲庫や提供元に問い合わせる。",
    "악보집을 찾거나 판매 공지를 확인하고, 곡목 자료실과 제공처를 방문하세요.",
  ],
