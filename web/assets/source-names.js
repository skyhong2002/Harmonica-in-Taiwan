...
const labels = {
  'zh-Hant': {original:'收錄原名', originalType:'原始類型', more:'其他名稱與分類', names:'名稱', types:'分類', reference:'譯名供辨識參考，不代表官方名稱；收錄名稱與原始來源並列保留。'},
  en: {original:'Recorded name', originalType:'Original type', more:'Other names and categories', names:'Names', types:'Categories', reference:'Translations are for reference, not official names. Recorded names and source links are preserved.'},
  ja: {original:'登録名', originalType:'元の分類', more:'別の名称と分類', names:'名称', types:'分類', reference:'訳名は識別のための参考訳で、公式名称を示すものではありません。登録名と出典を併記しています。'},
  ko: {original:'등록 이름', originalType:'원래 유형', more:'다른 이름과 분류', names:'이름', types:'분류', reference:'번역 이름은 식별을 위한 참고용이며 공식 명칭을 의미하지 않습니다. 등록 이름과 출처를 함께 표시합니다.'},
};
