...
const labels = {
  en: {share:'Share', original:'Open source'},
  'zh-Hant': {share:'分享', original:'開啟來源'},
  ja: {share:'共有', original:'元の投稿を開く'},
  ko: {share:'공유', original:'원문 열기'},
};
